...
class Challenge69Test {
  ...
  void shouldReportAnErrorWhenTheSkillHasNoToken() {
    var challenge = new Challenge69(skillContaining("# Deploy Preview\n\nNo secrets here.\n"));
  ...
  void shouldReportAnErrorWhenTheSkillCannotBeRead() {
    var challenge =
        new Challenge69(new ClassPathResource("challenges/challenge-69/does-not-exist.md"));
