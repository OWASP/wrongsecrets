...
class Challenge69ControllerTest {

  private static final String SKILL_LOCATION =
      "challenges/challenge-69/cursor-skill/deploy-preview/SKILL.md";

  @Test
  void shouldServeTheCursorSkillAsMarkdown() {
    var controller = new Challenge69Controller(new ClassPathResource(SKILL_LOCATION));
  ...
  void servedSkillShouldContainTheAnswerOfTheChallenge() {
    var controller = new Challenge69Controller(new ClassPathResource(SKILL_LOCATION));
    var challenge = new Challenge69(new ClassPathResource(SKILL_LOCATION));
  ...
  void shouldReturnServerErrorWhenTheSkillIsMissing() {
    var controller =
        new Challenge69Controller(new ClassPathResource("challenges/challenge-69/missing.md"));
