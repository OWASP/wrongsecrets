...
class Challenge70Test {
  ...
  private static final String SKILL_BUNDLE =
      "challenges/challenge-70/claude-skill/incident-reporter.skill";
  ...
  void spoilerShouldGiveTheDecodedTokenFromTheShippedSkill() {
    var challenge = new Challenge70(new ClassPathResource(SKILL_BUNDLE));
  ...
  void answerShouldNotBeTheEncodedValueThatIsInTheBundle() throws Exception {
    ...
    var challenge = new Challenge70(skillResource);
  ...
  void shouldDecodeTheTokenFromTheUploaderScript() {
    var challenge = new Challenge70(uploaderWithToken("t0k3n-from-the-bundle"));
  ...
  void shouldReportAnErrorWhenTheUploaderHasNoToken() {
    var challenge =
        new Challenge70(skillBundleContaining("TRACKER_URL = \"https://example.com\"\n"));
  ...
  void shouldReportAnErrorWhenTheTokenIsNotValidBase64() {
    var challenge =
        new Challenge70(skillBundleContaining("UPLOAD_TOKEN_B64 = \"not base64 %%\"\n"));
  ...
  void shouldReportAnErrorWhenTheUploaderCannotBeRead() {
    var challenge =
        new Challenge70(new ClassPathResource("challenges/challenge-70/does-not-exist.py"));
