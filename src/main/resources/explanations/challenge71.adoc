...
. Inspect the https://github.com/OWASP/wrongsecrets/tree/master/.devcontainer/devcontainer.json[`.devcontainer/devcontainer.json`] devcontainer configuration file in the project repository or review the configuration snippet in the UI.
