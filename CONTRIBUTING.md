...
3. **JDK-20**
   [_JDK_](https://www.oracle.com/java/technologies/downloads/#java20) is a tool used in development and testing programs written in the Java programming language.
