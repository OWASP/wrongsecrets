...
* **File [issues](https://github.com/commjoen/wrongsecrets/issues "WrongSecret Issues")** for missing content or errors. Explain what you think is missing and give a suggestion as to where it could be added.
...
4. Go to the newly cloned directory "wrongsecrets" and add the remote upstream repository:
    ...
    $ git remote add upstream git@github.com:commjoen/wrongsecrets.git

    $ git remote -v
    origin git@github.com:<your Github handle>/wrongsecrets.git (fetch)
    origin git@github.com:<your Github handle>/wrongsecrets.git (push)
    upstream git@github.com:commjoen/wrongsecrets.git (fetch)
    upstream git@github.com:commjoen/wrongsecrets.git (push)
    ```
