...
Requirements: make sure you have the following tools installed: [Docker](https://www.docker.com/products/docker-desktop/), [Java20 JDK](https://jdk.java.net/20/), [NodeJS 18](https://nodejs.org/dist/v18.12.1/node-v18.12.1-x86.msi) and [IntelliJ IDEA](https://www.jetbrains.com/idea/download).
...
3. Go to the project settings and make sure it uses Java20 (And that the JDK can be found)
